...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210506_savarti_ecb8caa0323d55404011_20210506065121_archive.zip';
	const ARCHIVE_SIZE		 = '159659807';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ecb8caa-06065121';
    const SECONDARY_PACKAGE_HASH = 'b18a28d-06065121';
	const VERSION			 = '1.4.0';
